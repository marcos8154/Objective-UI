...
FSPage.DISABLE_EXCEPTION_PAGE = false;
class FSView {
    ...
    initialize(mainShell) {
        ...
        this.widgetContext = new FSWidgetContext(this.shellPage, layoutCollection, this.onWidgetMessage);
        this.view = this;
    ...
    createWidgetContext(managedDivIds, messageProtocol) {
        ...
        return new FSWidgetContext(this.shellPage, managedDivIds, messageProtocol);
    }
}
class FSWidget {
    /**
...
class Row {
    constructor(id, options) {
        ...
        if ((this.rowColumns == null || this.rowColumns == undefined) || this.rowColumns.length == 0) {
            var id = `col_${FSWidget.generateUUID()}`;
...
class FSHeadBinder extends WidgetBinder {
    constructor(head) {
        super(head);
        this.head = head;
    }
...
class RadioOption {
    constructor(text, value, fieldSetId, shell) {
        var template = new FSTemplateView(`<div id="radioOptionContainer" style="margin-right: 10px" class="custom-control custom-radio">
...
class FSRadioGroupBinder extends WidgetBinder {
...
class FSRadioGroup extends FSWidget {
    /**
    *
...
class FSButton extends FSWidget {
...
class FSCheckBoxBinder extends WidgetBinder {
...
class FSCheckBox extends FSWidget {
...
class FSImageViewBinder extends WidgetBinder {
    constructor(image) {
        super(image);
        this.img = image;
    }
...
class FSImageView extends FSWidget {
...
class FSLabelBinder extends WidgetBinder {
    constructor(label) {
        super(label);
        this.label = label;
    }
...
class FSLabel extends FSWidget {
    constructor({ name, text }) {
        super(name);
        this.lblText = text;
    }
...
class FSListViewBinder extends WidgetBinder {
...
class FSListView extends FSWidget {
    /**
     *
...
class FSModalView extends FSWidget {
    constructor({ shell, name, title, contentTemplate, actions }) {
        ...
        this.modalContext = new FSWidgetContext(shell, [modalDivContainer.id], null);
    }
    htmlTemplate() {
        return `
...
class FSNavBar extends FSWidget {
    constructor(name) {
        super(name);
    }
    htmlTemplate() {
...
class FSProgressBar extends FSWidget {
    onWidgetDidLoad() {
        throw new Error("Method not implemented.");
    }
    htmlTemplate() {
...
class FSSelectBinder extends WidgetBinder {
    constructor(select) {
        super(select);
        this.select = select;
    }
...
class FSSelect extends FSWidget {
    constructor({ name }) {
        super(name);
...
class FSSpinner extends FSWidget {
    onWidgetDidLoad() {
        throw new Error("Method not implemented.");
    }
    htmlTemplate() {
...
class FSSwitcher extends FSWidget {
    onWidgetDidLoad() {
        throw new Error("Method not implemented.");
    }
    htmlTemplate() {
...
class FSTextBox extends FSWidget {
...
class FSToast extends FSWidget {
    onWidgetDidLoad() {
        throw new Error("Method not implemented.");
    }
    htmlTemplate() {
...
class FSDataGridBinder extends WidgetBinder {
...
class FSDataGrid extends FSWidget {
